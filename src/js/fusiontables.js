...
(function() {
  var FUSION_TABLES_URI, add_related_url, build_gazcomp_driver, check_table_access, default_gazcomp_config, delete_cookie, expires_in_to_date, filter_url_params, fusion_tables_escape, fusion_tables_query, gazcomp_config, get_cookie, get_next_gazcomp_pair, google_oauth_parameters_for_fusion_tables, google_oauth_url, load_related_urls, parse_query_string, process_gazcomp_result, set_access_token_cookie, set_author_name, set_cookie, set_cookie_expiration_callback;
  ...
  get_next_gazcomp_pair = function() {
    return fusion_tables_query("SELECT COUNT() FROM " + gazcomp_config.worklist_fusion_table_id, function(fusion_tables_result) {
      ...
      return fusion_tables_query("SELECT url1, url2 FROM " + gazcomp_config.worklist_fusion_table_id + " OFFSET " + random_offset + " LIMIT 1", function(fusion_tables_result) {
        ...
        return fusion_tables_query("SELECT COUNT() FROM " + gazcomp_config.votes_fusion_table_id + " WHERE url1 = " + (fusion_tables_escape(url1)) + " AND url2 = " + (fusion_tables_escape(url2)), function(fusion_tables_result) {
